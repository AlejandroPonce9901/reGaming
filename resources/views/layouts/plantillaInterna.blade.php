...
">Navegación en el sitio</h3>
                ...
                <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('roles.index') }}">Puestos/Áreas</a>
                            </li>
                            @else
          ...
          @endif
                            ...
                            @endif     
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('compr.index') }}">Compras</a>
                            </li>
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('dcompra.index') }}">Detalle de Compras</a>
                            </li>
                            ...
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('dventa.index') }}">Detalle de Ventas</a>
                            </li>
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('contactos.index') }}">Mensajes</a>
                            </li>                                   
        ...
        <!--<div class="row services-list block-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Buscamos llevar al límite las ventas y compras de nuestros producto clásicos, y brindar un excelente servicio a nuestros clientes mediante nuestra especialización en videojuegos, además de tener en buen estado cualquier producto.
                    </p>
                </div>
            </div>
...
﻿.
    ...
    <!-- works
    ================================================== -->
    <!--section id='producto' class="s-works">
