...
session_start();
	...
	if($f2=mysqli_fetch_assoc($sql2)){
		if($pass==$f2['pasadmin']){
			...
			$_SESSION['rol']=$f2['rol'];
			$_SESSION['area']=$f2['area'];
			$_SESSION['puesto']=$f2['puesto'];
			$_SESSION['status']=$f2['status'];
			$_SESSION['fecha']=$f2['fechaingreso'];
	...
	if($f=mysqli_fetch_assoc($sql)){
		if($pass==$f['password']){
			...
			$_SESSION['puesto']=$f['puesto'];
			$_SESSION['status']=$f['status'];
			$_SESSION['fecha']=$f['fechaingreso'];
